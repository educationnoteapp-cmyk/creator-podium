...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  'Content-Security-Policy': [
    ...
    "img-src 'self' data: blob: https://unavatar.io https://api.dicebear.com https://pbs.twimg.com https://www.gstatic.com https://fzeupxiivncgifbyxqjy.supabase.co https:",
